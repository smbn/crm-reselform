      ...
      <div class="panel-body">
         ...
         <div class="row mtop10">
            <div class="col-md-6" id="expenseHeadings">
               ...
               <?php } ?>
                <h4 class="text-muted font-medium no-mtop" id="expenserCreator">
                    <?php echo _l('created_by'); ?>: <a href="<?php echo admin_url('staff/profile/' . $expense->addedfrom) ?>"><?php echo get_staff_full_name($expense->addedfrom); ?></a>
                </h4>
            </div>
